...
//       const isSameProdictExistinBasket = basket.filter(
//         (product) =>
//         Number(product.productId) === Number(id)
//       );

//     if(!isSameProdictExistinBasket.length){
//       try{
...
//         const updateBasketItem = basket.map((item,idx) =>{
...
//           (item,idx) =>
//           (item.productId !== productId && index !== idx) || (item.productId === productId && index !== idx)
//         );
